...
public abstract class BinomialDividendVanillaEngine<T extends Tree> extends DividendVanillaOption.EngineImpl {
   ...
   public void calculate() /*@ReadOnly*/ {
       ...
       final YieldTermStructure flatRiskFree  = new FlatForward(referenceDate, rRate, rfdc);
       final YieldTermStructure flatDividends = new FlatForward(referenceDate, qRate, divdc);
       final BlackVolTermStructure flatVol = new BlackConstantVol(referenceDate, volcal, v, voldc);
