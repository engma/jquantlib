 ...
 *
 */
public class Bonds2 { //implements Runnable {
    ...
    public void run() {
        ...
        final List<Quote> quoteHandle = new ArrayList<Quote>(numberOfBonds);
        for (int i = 0; i < numberOfBonds; i++) {
        	final SimpleQuote sq = new SimpleQuote(marketQuotes[i]);
        	final Quote handle = sq;
            quote.add(sq);
...
//        }
        ...
        final Quote[] jumps1 = new Quote[0];
        ...
        final IborIndex  swFloatingLegIndex = new Euribor6M(null);
...
//        final IborIndex swFloatingLegIndex = new Euribor6M(new Handle<YieldTermStructure>(nullYieldTermStructure));
         ...
         *********************/
         ...
         final Quote[] jumps= new Quote[0];//]<Quote>[]) new ArrayList<Quote>().toArray();
         ...
         YieldTermStructure discountingTermStructure = null;
         // the one used for forward rate forecasting
         YieldTermStructure forecastingTermStructure = null;
        ...
        final PricingEngine  bondEngine = new DiscountingBondEngine(discountingTermStructure);
         ...
         YieldTermStructure liborTermStructure = null;
         ...
         forecastingTermStructure = depoSwapTermStructure;
         discountingTermStructure = bondDiscountingTermStructur;
        
         // We are using the depo & swap curve to estimate the future Libor
         // rates
         liborTermStructure = depoSwapTermStructure;
